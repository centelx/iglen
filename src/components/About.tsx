    ...
    <section id="about" className="py-20 bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="bg-primary text-white rounded-2xl p-12 shadow-2xl relative overflow-hidden"
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              Od prostych przeglądów po skomplikowane naprawy silników i turbosprężarek.
              Każde zlecenie traktujemy indywidualnie, dbając o najwyższą jakość wykonania.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <div className="bg-white/10 backdrop-blur-md px-8 py-4 rounded-xl border border-white/20">
                <div className="text-3xl font-bold mb-1">25+</div>
                <div className="text-sm text-gray-200">Lat doświadczenia</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md px-8 py-4 rounded-xl border border-white/20">
                <div className="text-3xl font-bold mb-1">5</div>
                <div className="text-sm text-gray-200">Lat w Zatorze</div>
              </div>
              <div className="bg-white/10 backdrop-blur-md px-8 py-4 rounded-xl border border-white/20">
                <div className="text-3xl font-bold mb-1">100%</div>
                <div className="text-sm text-gray-200">Zadowolonych klientów</div>
              </div>
            </div>
          </div>
        </motion.div>
